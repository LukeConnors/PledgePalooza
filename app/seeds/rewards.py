...
def seed_rewards():
    ...
    reward8 = Reward(
        ...
        img='limited_edition_poster.jpg',
        price=30,
    ...
    reward62 = Reward(
        ...
        img="collectors_edition_cards.jpg",
        price=40,
    ...
    reward14 = Reward(
        ...
        img="digital_art_collection.jpg",
        price=30,
    ...
    reward15 = Reward(
        ...
        img="ultimate_cybernetic_upgrade.jpg",
        price=100,
    ...
    reward16 = Reward(
        ...
        img="exclusive_in_game_character.jpg",
        price=50,
        est_delivery="2023-12-01",
        quantity=75,
    )
    ...
    reward17 = Reward(
        ...
        img="dragon_tamers_starter_kit.jpg",
        price=20,
        est_delivery="2024-01-15",
        quantity=200,
    )
    ...
    reward18 = Reward(
        ...
        img="limited_edition_art_book.jpg",
        price=35,
        est_delivery="2023-12-31",
        quantity=100,
    )
    ...
    reward19 = Reward(
        ...
        img="legendary_dragon_figurine.jpg",
        price=75,
        est_delivery="2023-12-15",
        quantity=50,
    )
    ...
    reward20 = Reward(
        ...
        img="custom_character_illustration.jpg",
        price=50,
        est_delivery="2023-12-01",
        quantity=75,
    )
    ...
    reward21 = Reward(
        ...
        img="virtual_dive_certification.jpg",
        price=30,
        est_delivery="2024-01-15",
        quantity=150,
    )
    ...
    reward22 = Reward(
        ...
        img="ocean_explorers_bundle.jpg",
        price=50,
        est_delivery="2023-12-31",
        quantity=100,
    )
    ...
    reward24 = Reward(
        ...
        img="underwater_photography_course.jpg",
        price=40,
        est_delivery="2023-12-01",
        quantity=75,
    )
    ...
    reward28 = Reward(
        ...
        img="quantumx_research_grant.jpg",
        price=500,
    ...
    reward32 = Reward(
        ...
        img="lunalens_exclusive_access.jpg",
        price=99,
        est_delivery="2024-03-31",
        quantity=200,
    )
    ...
    reward35 = Reward(
        ...
        img="skyhawk_autonomous_kit.jpg",
        price=1199,
    ...
    reward36 = Reward(
        ...
        img="skyhawk_exclusive_access.jpg",
        price=99,
    ...
    reward37 = Reward(
        ...
        img="ecocharge_essential_pack.jpg",
        price=79,
        est_delivery="2024-04-15",
        quantity=100,
    )
    ...
    reward38 = Reward(
        ...
        img="ecocharge_ultimate_pack.jpg",
        price=129,
    ...
    reward39 = Reward(
        ...
        img="ecocharge_solar_backpack.jpg",
        price=149,
    ...
    reward40 = Reward(
        ...
        img="ecocharge_eco_warrior_bundle.jpg",
        price=299,
    ...
    reward41 = Reward(
        ...
        img="ecostyle_essential_collection.jpg",
        price=99,
    ...
    reward42 = Reward(
        ...
        img="ecostyle_premium_collection.jpg",
        price=149,
    ...
    reward43 = Reward(
        ...
        img="ecostyle_sustainable_accessories.jpg",
        price=49,
        est_delivery="2024-08-15",
        quantity=30,
    )
    ...
    reward44 = Reward(
        ...
        img="ecostyle_eco_chic_wardrobe.jpg",
        price=249,
    ...
    reward45 = Reward(
        ...
        img="urbanthreads_classic_tee.jpg",
        price=39,
        est_delivery="2024-08-01",
        quantity=100,
    )
    ...
    reward48 = Reward(
        ...
        img="urbanthreads_streetwear_bundle.jpg",
        price=149,
    ...
    reward50 = Reward(
        ...
        img="epictales_collectors_set.jpg",
        price=99,
    ...
    reward55 = Reward(
        ...
        img="cookbook_cooking_class.jpg",
        price=89,
    ...
    reward58 = Reward(
        ...
        img="whodunit_collectors_set.jpg",
        price=99,
    ...
    reward59 = Reward(
        ...
        img="whodunit_detective_kit.jpg",
        price=149,
