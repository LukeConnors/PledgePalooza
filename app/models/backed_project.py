...
class BackedProject(db.Model):
    ...
    projectId = db.Column(db.Integer, add_prefix_for_prod(db.ForeignKey('projects.id')), nullable=False)
    rewardId = db.Column(db.Integer, add_prefix_for_prod(db.ForeignKey('rewards.id')), nullable=False)
